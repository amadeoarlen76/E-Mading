...
// Update jumlah viewers di tabel post
$updateQuery = "UPDATE post SET views = views + 1 WHERE id = $postId";
...
<body>
    ...
    <header class="header-top bg-grey justify-content-center">
        <nav class="navbar navbar-expand-lg navigation">
            <div class="container">
                <a class="navbar-brand d-lg-none" href="../index.php"><img src="images/logo.png" alt=""
                        class="img-fluid"></a>
    ...
    <section class="single-block-wrapper section-padding">
        ...
        <div class="post-header mb-5 text-center">
            ...
            <div class="post-meta">
                <span class="text-uppercase font-sm letter-spacing-1 mr-3">by <?php echo $row['creator']; ?></span>
            ...
            <div class="post-featured-image mt-5">
                <img src="../admin/pages/prosesdata/uploads/<?php echo $row['gambar']; ?>" class="img-fluid w-100" alt="featured-image">
            </div>
        </div>
        <div class="post-body">
